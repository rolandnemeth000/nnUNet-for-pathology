...
class nnUNetTrainer_WSD_wei_i0_nnunet_aug_json_TIME(nnUNetTrainer_WSD_undefined_dataloader):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.iterator_template = f'wsd_{self.label_sampling_strategy}_iterator_{self.aug}_aug_json'
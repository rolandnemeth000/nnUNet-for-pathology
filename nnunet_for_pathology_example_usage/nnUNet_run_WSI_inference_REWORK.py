...
task_name = 'Task031_batch1_2_3_4_6_to_train_roi_based_split'
...
output_folder = Path(f'/data/pathology/projects/pathology-lung-TIL/nnUNet_raw_data_base/inference_results/REWORK_FINAL_{task_name}_{dataset_name}')
